...
int main(int ac, char *av[])
{
	...
	SimpleDynamics<solid_dynamics::UpdateElasticNormalDirection> beam_update_normal(beam_body);
	//-----------------------------------------------------------------------------
	// outputs
	//-----------------------------------------------------------------------------
	...
	beam_normal_direction.parallel_exec();
	...
	while (GlobalStaticVariables::physical_time_ < end_time)
	{
		...
		while (integration_time < output_interval)
		{
			...
			beam_update_normal.parallel_exec();
			...
			while (relaxation_time < Dt)
			{
				...
				artificial_viscosity.parallel_exec(dt);
