/**
 * @file 	two_phase_dambreak_HEU.cpp
 * @brief 	2D two-phase dambreak flow by using Compressible fluid framework.
 * @details This is the one of the basic test cases, also the first case for
 * 			understanding SPH method for multi-phase simulation.
 * @author 	Haotian Shi from SJTU
 */
...
Real rho0_a = 100.0;					 /**< Reference density of air. */
Real gamma_f = 7.15;					 /**< Specific heat ratio of water. */
Real gamma_a = 1.25;					 /**< Specific heat ratio of air. */
Real gravity_g = 9.81;					 /**< Gravity force of fluid. */
Real U_max = 2.0 * sqrt(gravity_g * LH); /**< Characteristic velocity. */
Real c_f = 10.0 * U_max;				 /**< Reference sound speed. */
Real c_a = sqrt( rho0_f * c_f * c_f / gamma_f * gamma_a / rho0_a);
Real B_f = rho0_f * c_f * c_f / gamma_f;
Real B_a = 0.0;
//----------------------------------------------------------------------
...
int main()
{
	...
	water_block.defineParticlesAndMaterial<CompressibleFluidParticles, CompressibleFluid>(rho0_f, gamma_f, 0.0, B_f);
	water_block.generateParticles<ParticleGeneratorLattice>();

	FluidBody air_block(sph_system, makeShared<AirBlock>("AirBody"));
	air_block.defineParticlesAndMaterial<CompressibleFluidParticles, CompressibleFluid>(rho0_a, gamma_a, 0.0, B_a);
