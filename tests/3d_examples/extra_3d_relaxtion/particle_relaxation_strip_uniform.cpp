...
//----------------------------------------------------------------------
Vec3d domain_lower_bound( -strip_X - BW, -strip_Y - BW, -strip_Z - BW);
Vec3d domain_upper_bound(strip_X + BW, strip_Y + BW, strip_Z + BW);
...
int main()
{
	...
	std::cout << "Reload file written" << std::endl;
	return 0;
}
