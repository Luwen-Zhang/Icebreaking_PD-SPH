/*-----------------------------------------------------------------------------*
 *       SPHinXsys: 3D example J2 / DP Plasticity Benchmark for PD             *
 *-----------------------------------------------------------------------------*
...
Real bar_Y = 0.03;	/**< 0.5 * length of the metal bar. */
Real bar_R = 0.015;	/**< radius of the metal bar. */
int resolution(20);
...
//----------------------------------------------------------------------
Real rho0_s = 3000.0;	 /**< Reference density of bar. */
Real poisson = 0.3; /**< Poisson ratio. */
Real Youngs_modulus = 10e9;
//Damage parameters
Real sigma_t0 = 100e6;
Real sigma_c0 = 2.0 * sigma_t0;
...
int main(int ac, char* av[])
{
	...
	//----------------------------------------------------------------------
	BoundingBox system_domain_bounds(Vecd(-bar_R - BW, -bar_Y -BW, -bar_R - BW), Vecd(bar_R + BW, bar_Y + BW, bar_R + BW));
	...
	/*bar.defineParticlesAndMaterial<NosbPDPlasticParticles, J2PlasticityforPD>(rho0_s, Youngs_modulus, poisson, 
		sigma_Y0, isohardening_modulus_H, kinhardening_modulus_H);*/
	bar.defineParticlesAndMaterial<NosbPDPlasticParticles, DruckerPragerPlasticityforPD>(rho0_s, Youngs_modulus, poisson,
		cohesive0, friction_angle, isohardening_modulus_H, kinhardening_modulus_H);
