...
int main(int ac, char* av[])
{
	...
	InteractionDynamics<solid_dynamics::BondBreakByPlasticStrain> check_bondLive(bar_inner_relation, max_plastic_strain);
